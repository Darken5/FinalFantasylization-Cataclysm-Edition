...
--		Dawning Woods Catacombs			FinalFantasylization_SubzoneDawningWoodsCatacombs()
--	Roland's Doom					FinalFantasylization_SubzoneRolandsDoom()
--	The Rotting Orchard				FinalFantasylization_SubzoneTheRottingOrchard()
--	The Tranquil Gardens Cemetery	FinalFantasylization_SubzoneTheTranquilGardensCemetery()
...
--	The Yorgen Farmstead			FinalFantasylization_SubzoneTheYorgenFarmstead()
	...
	elseif ( SubZoneName == SZ["Raven Hill Cemetery"] ) then
		...
		return
	--'==========================================================================================
	--' Duskwood Subzone: Dawning Woods Catacombs
	--'==========================================================================================
	elseif ( SubZoneName == SZ["Dawning Woods Catacombs"] ) then
		if FinalFantasylization_CurrentZone ~= SubZoneName then
			FinalFantasylization_debugMsg(FFZlib.Color.Aqua .. PlayerIn.. SubZoneName..", "..ZoneName)
			FinalFantasylization_CurrentZone = SubZoneName
			FinalFantasylization_SubzoneDawningWoodsCatacombs()
		else
			return
		end
		FinalFantasylization_IsPlaying = true
	...
	elseif ( SubZoneName == SZ["The Rotting Orchard"] ) then
		...
		return
	--'==========================================================================================
	--' Duskwood Subzone: The Tranquil Gardens Cemetery
	--'==========================================================================================
	elseif ( SubZoneName == SZ["The Tranquil Gardens Cemetery"] ) then
		if FinalFantasylization_CurrentZone ~= SubZoneName then
			FinalFantasylization_debugMsg(FFZlib.Color.Aqua .. PlayerIn.. SubZoneName..", "..ZoneName)
			FinalFantasylization_CurrentZone = SubZoneName
			FinalFantasylization_SubzoneTheTranquilGardensCemetery()
		else
			return
		end
		FinalFantasylization_IsPlaying = true
